...
//-----------------------------------------------
#define CS_CHANNEL_MASK (1L<<0x0f)				// 32-bit mask of channels to be scanned before network is started.
#define CS_EXT_PANID 0x1AAAAAAAAAAACAFELL		// 64-bit unique PAN ID.
#define CS_UID 0x10000000A01LL					// 64-bit Unique Identifier (UID) determining the device extended address.
#define CS_DEVICE_TYPE DEVICE_TYPE_COORDINATOR	// ZigBee device type.
